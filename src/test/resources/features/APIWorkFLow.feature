...
Scenario:Retrieving created employee
  ...
  And the retrieved employee ID "employee.employee_id" should match the globally stored employeed id
  ...
  |Aaliyah      |Andrea         |Smith       |1989-09-11  |Male     |API Tester   |Employee   |
